...
# print(svalue) # lower() 나 uppper() 메서드를 사용해도 원본데이터는 변하지 않는다.

# print(svalue.swapcase()) # 대 소문자를 스위칭.
# print(svalue.capitalize()) # 문자열의 첫 영문자 만 대문자
# print(svalue.title()) # 문자열의 문단 별로 첫 영문자 소문자(카멜론 표기법)


# # 대 / 소문자 변경 기능의 활용
# # 로그인 기능 시 대 / 소문자 구별 하고 싶지 않을 때
# # 프로그램은 대 / 소문자를 구별하지만 사용자는 대 / 소문자를 다른 문자로 인식하지 않는다.
# # 로그인 기능

# dbUserId = "Admin" # 데이터 베이스에 등록되어있는 사용자 ID다.
...
# svalue = "안녕하세요 000 입니다."
# print(svalue)
# print(svalue.replace("000", "김범수"))
...
# # 실습 5
print("\n 5. DIGITAL TRAINING 을 소문자로 표현 첫글자만 대문자.")
