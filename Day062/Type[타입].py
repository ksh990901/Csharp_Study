...
# # # 다른 진법으로 표현
# print(bin(3))  # 10진수 3을 2진법으로
# print(oct(8))  # 10진수 8을 8진법으로 
...
# print("C:\\Python\\source") # 경로를 나타내는 문자열은 r을 통항 \ 를 한번만 쓸수 있다.
...
#######################################################
# # 진위 형 True/False
# #  . 참과 거짓을 1과 0으로 표현, 가독성이 좋은(코드를 보기 쉽다.)
# # 코드를 구현 하도록 True / False로 표현하기 위해 발생
