#####################################################################
# # 모듈
# # 파이썬 코드를 작성해 놓은 스크립트 파일, 함수, 변수, 클래스 등이 정의되어있다.
# #  .누군가가 작성해둔 복잡한 로직을 활용하여 프로그램의 개발 생산성을 향상 시킬 수 있다.
# #  .import : 외부 모듈을 참조.
#####################################################################
...
###################### 현재 시각을 나타내는 모듈
# import time
# print(time.time()) # 1970년 1월 1일 자정부터의 초.
...
# print("1995년 광복절은 %s 요일입니다." %yoil[day])
...
# print(ran.random()) # 0 ~ 0.999999999 까지의 난수 생성
# print(ran.randint(1,10)) # 1 ~ 10 까지의 난수 생성.
# print(ran.uniform(1,100)) # 일정한 로직으로 알고리즘을 통하여 난수의 결과를 반환
#                           # 데이터의 암호화를 작성할 때 사용
#                           # 시작값 + ( 종료값 - 시작값 ) * 난수
...
# print(food[i])
# i = ran.randrange(len(food)) # randint는 이상, 미만의 범위.
# print(food[i])
